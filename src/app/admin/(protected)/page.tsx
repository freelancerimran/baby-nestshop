...
async function getDashboardData() {
  ...
  Cancelled orders remain in:

  - Total order count
  - Recent order history
  - Status/history views

  But they must NOT contribute to:
  ...
  */
  ...
  Cancelled orders do not count as sold.
  ========================================
  */
  ...
  */
  ...
  return {
    ...
    /*
    All orders:
    Used for history / Recent Orders.
    */
    orders,
...
export default async function AdminPage() {
  ...
  return (
    <div className="space-y-8 p-8">
      ...
      IMPORTANT:
      Only non-cancelled orders are sent
